...
function EditRisultatiTestMOCA(props){
    ...
    useEffect(() => {
        ...
        for(var i=0; i < props.risultatiTest.length; i++){
            switch(i){
                ...
                case 8:
                    // if(props.risultatiTest[i].risposta === 1){
                        setNumeroTentativi(props.risultatiTest[i].risposta)
                    // }
                    break;
                case 9:
                    if(props.risultatiTest[i].risposta === 1){
                ...
                case 11:
                    ...
                    break;
                case 12:
                    set_areaCog_4_domanda_4(props.risultatiTest[i].risposta)
                    if(props.risultatiTest[i].risposta === 3){
                        set_a4d4_option_1(true)
                    }
                    if(props.risultatiTest[i].risposta === 2){
                        set_a4d4_option_2(true)
                    }
                    if(props.risultatiTest[i].risposta === 1){
                        set_a4d4_option_3(true)
                    }
                    if(props.risultatiTest[i].risposta === 0){
        ...
        <>
            ...
            <div className={styles.wrapper_horizontal}>
                ...
                {showSintesiRisultati &&
                    <GenericButton
                        onClick={() => {
                            tests_ctx.aggiornaRisultatoTestMoCA(punteggioTOT, paziente, arrayRiassuntivoRisposte, auth_ctx.utenteLoggatoUID, props.testID)
...
export default EditRisultatiTestMOCA;