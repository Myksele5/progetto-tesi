...
function MainMenu(props){
    ...
    return(
        <div className={styles.wrap_menu}>
            ...
            <div onClick = {goToPazienti} className={styles.menu_option}>
            ...
            <div onClick = {goToAttività} className={styles.menu_option}>
            ...
            <div onClick = {goToGiochi} className={styles.menu_option}>
            ...
            <div onClick = {goToDialoghi} className={styles.menu_option}>
